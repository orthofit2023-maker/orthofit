			...
			<div class="row">
				<div class="item col-lg-3 col-md-4 col-6">
					...
					<div class="product-image">
						...
						<a href="product-layout1.html" class="product-img">
							<!--Image-->
							<img class="primary blur-up lazyload" data-src="assets/images/products/product-6.jpg" src="assets/images/products/product-6.jpg" alt="image" title="" width="800" height="960">
							<!--End image-->
							<!--Hover image-->
							<img class="hover blur-up lazyload" data-src="assets/images/products/product-6-1.jpg" src="assets/images/products/product-6-1.jpg" alt="image" title="" width="800" height="960">
							<!--End hover image-->
						</a>
						<!--end product image-->
				...
				<div class="item col-lg-3 col-md-4 col-6">
					...
					<div class="product-image">
						...
						<a href="product-layout1.html" class="product-img">
							<!--Image-->
							<img class="primary blur-up lazyload" data-src="assets/images/products/product-7.jpg" src="assets/images/products/product-7.jpg" alt="image" title="" width="800" height="960">
							<!--End image-->
							<!--Hover image-->
							<img class="hover blur-up lazyload" data-src="assets/images/products/product-7-1.jpg" src="assets/images/products/product-7-1.jpg" alt="image" title="" width="800" height="960">
							<!--End hover image-->
						</a>
						<!--End Product Image-->
						...
						<div class="button-set-bottom position-absolute style1">
							<!--Cart Button-->
							<a class="btn-icon btn btn-addto-cart pro-quickshop-popup rounded" href="#pro-quickshop" data-bs-toggle="offcanvas" data-bs-target="#pro-quickshop" aria-controls="pro-quickshop">
						...
						<div class="quickshop-content d-flex-center" data-bs-scroll="true" data-bs-backdrop="false" tabindex="-1" id="pro-quickshop">
							...
							<div class="offcanvas-body quickshop-variant h-100 d-flex align-items-start align-items-sm-center">
								<form method="post" action="#" id="product_form_1051" class="product-form align-items-center text-center hidedropdown" accept-charset="UTF-8" enctype="multipart/form-data">
									<!-- Product Price -->
									<div class="product-single__price lh-1 mb-3 mt-0 mx-auto">
										<span class="visually-hidden">Regular price</span>
										<span class="product-price__sale--single">
											<span class="product-price-old-price">$114.00</span><span class="product-price__price product-price__sale">$99.00</span>   
										</span>
									</div>
									<!-- End Product Price -->
									<!-- Swatches Color -->
									<div class="swatches-image swatch clearfix mb-3 swatch-0 option1" data-option-index="0">
										<div class="product-form__item">
											<label class="label d-flex justify-content-center">Color:<span class="required d-none">*</span><span class="slVariant ms-1 fw-bold">Green</span></label>
					...
					<div class="product-details text-center">
						<!--Product Name-->
						<div class="product-name text-uppercase">
							<a href="product-layout1.html">Crew Neck Sweater</a>
						</div>
						<!--End Product Name-->
						<!--Product Price-->
						<div class="product-price">
				...
				<div class="item col-lg-3 col-md-4 col-6">
					...
					<div class="product-image">
						...
						<a href="product-layout1.html" class="product-img">
							<!--Image-->
							<img class="primary blur-up lazyload" data-src="assets/images/products/product-8.jpg" src="assets/images/products/product-8.jpg" alt="image" title="" width="800" height="960">
							<!--End image-->
							<!--Hover image-->
							<img class="hover blur-up lazyload" data-src="assets/images/products/product-8-1.jpg" src="assets/images/products/product-8-1.jpg" alt="image" title="" width="800" height="960">
							<!--End hover image-->
							<!-- product label -->
						...
						<div class="button-set-bottom position-absolute style1">
							<!--Cart Button-->
							<a class="btn-icon btn btn-addto-cart pro-quickshop-popup rounded" href="#pro-quickshop1" data-bs-toggle="offcanvas" data-bs-target="#pro-quickshop1" aria-controls="pro-quickshop1">
								<i class="icon an an-cart-l"></i> <span>Quick Shop</span>
							</a>
							<!--End Cart Button-->
						</div>
									...
									<div class="swatches-image swatch clearfix mb-3 swatch-0 option1" data-option-index="0">
										<div class="product-form__item">
											...
											<ul class="swatches d-flex-justify-center list-unstyled m-0 clearfix">
												...
												<li data-value="Peach" class="swatch-element rounded-0 color navy available">
													<label class="swatchLbl rounded-0 color small red" title="Red"></label>
													<span class="tooltip-label top">Red</span>
												</li>
												<li data-value="White" class="swatch-element rounded-0 color purple available">
				...
				<div class="item col-lg-3 col-md-4 col-6">
					...
					<div class="product-image">
						...
						<a href="product-layout1.html" class="product-img">
							<!--Image-->
							<img class="primary blur-up lazyload" data-src="assets/images/products/product-9.jpg" src="assets/images/products/product-9.jpg" alt="image" title="" width="800" height="960">
							<!--End image-->
							<!--Hover image-->
							<img class="hover blur-up lazyload" data-src="assets/images/products/product-9-1.jpg" src="assets/images/products/product-9-1.jpg" alt="image" title="" width="800" height="960">
							<!--End hover image-->
						</a>
						<!--End Product Image-->
				...
				<div class="item col-lg-3 col-md-4 col-6">
					...
					<div class="product-image">
						...
						<a href="product-layout1.html" class="product-img">
							<!--Image-->
							<img class="primary blur-up lazyload" data-src="assets/images/products/product-10.jpg" src="assets/images/products/product-10.jpg" alt="image" title="" width="800" height="960">
							<!--End image-->
							<!--Hover image-->
							<img class="hover blur-up lazyload" data-src="assets/images/products/product-10-1.jpg" src="assets/images/products/product-10-1.jpg" alt="image" title="" width="800" height="960">
							<!--End hover image-->
						</a>
						<!--End Product Image-->
					...
					<div class="product-details text-center">
						<!--Product Name-->
						<div class="product-name text-uppercase">
							<a href="product-layout1.html">Tote Bag</a>
						</div>
						<!--End Product Name-->
						<!--Product Price-->
						<div class="product-price">
				...
				<div class="item col-lg-3 col-md-4 col-6">
					...
					<div class="product-image">
						...
						<a href="product-layout1.html" class="product-img">
							<!--Image-->
							<img class="primary blur-up lazyload" data-src="assets/images/products/product-11.jpg" src="assets/images/products/product-11.jpg" alt="image" title="" width="800" height="960">
							<!--End image-->
							<!--Hover image-->
							<img class="hover blur-up lazyload" data-src="assets/images/products/product-11-1.jpg" src="assets/images/products/product-11-1.jpg" alt="image" title="" width="800" height="960">
							<!--End hover image-->
						</a>
						<!--End Product Image-->
				...
				<div class="item col-lg-3 col-md-4 col-6">
					...
					<div class="product-image">
						...
						<a href="product-layout1.html" class="product-img">
							<!--Image-->
							<img class="primary blur-up lazyload" data-src="assets/images/products/product-21.jpg" src="assets/images/products/product-21.jpg" alt="image" title="" width="800" height="960">
							<!--End image-->
							<!--Hover image-->
							<img class="hover blur-up lazyload" data-src="assets/images/products/product-21-1.jpg" src="assets/images/products/product-21-1.jpg" alt="image" title="" width="800" height="960">
							<!--End hover image-->
						</a>
						<!--End Product Image-->
				...
				<div class="item col-lg-3 col-md-4 col-6">
					...
					<div class="product-image">
						...
						<a href="product-layout1.html" class="product-img">
							<!--Image-->
							<img class="primary blur-up lazyload" data-src="assets/images/products/product-22.jpg" src="assets/images/products/product-22.jpg" alt="image" title="" width="800" height="960">
							<!--End image-->
							<!--Hover image-->
							<img class="hover blur-up lazyload" data-src="assets/images/products/product-22-1.jpg" src="assets/images/products/product-22-1.jpg" alt="image" title="" width="800" height="960">
							<!--End hover image-->
						</a>
						<!--End Product Image-->

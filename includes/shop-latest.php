		...
		<div class="productSlider grid-products">
			<div class="item">
				...
				<div class="product-image">
					...
					<a href="product-layout1.html" class="product-img">
						<!--Image-->
						<img class="primary blur-up lazyload" data-src="assets/images/products/product-1.jpg" src="assets/images/products/product-1.jpg" alt="image" title="" width="800" height="960">
						<!--End image-->
						<!--Hover image-->
						<img class="hover blur-up lazyload" data-src="assets/images/products/product-1-1.jpg" src="assets/images/products/product-1-1.jpg" alt="image" title="" width="800" height="960">
						<!--End hover image-->
					</a>
					<!--end product image-->
			...
			<div class="item">
				...
				<div class="product-image">
					...
					<a href="product-layout1.html" class="product-img">
						<!--Image-->
						<img class="primary blur-up lazyload" data-src="assets/images/products/product-2.jpg" src="assets/images/products/product-2.jpg" alt="image" title="" width="800" height="960">
						<!--End image-->
						<!--Hover image-->
						<img class="hover blur-up lazyload" data-src="assets/images/products/product-2-1.jpg" src="assets/images/products/product-2-1.jpg" alt="image" title="" width="800" height="960">
						<!--End hover image-->
						<!-- product label -->
			...
			<div class="item">
				...
				<div class="product-image">
					...
					<a href="product-layout1.html" class="product-img">
						<!--Image-->
						<img class="primary blur-up lazyload" data-src="assets/images/products/product-3.jpg" src="assets/images/products/product-3.jpg" alt="image" title="" width="800" height="960">
						<!--End image-->
						<!--Hover image-->
						<img class="hover blur-up lazyload" data-src="assets/images/products/product-3-1.jpg" src="assets/images/products/product-3-1.jpg" alt="image" title="" width="800" height="960">
						<!--End hover image-->
					</a>
					<!--End Product Image-->
					<!--Product label-->
			...
			<div class="item">
				...
				<div class="product-image">
					...
					<a href="product-outofstock.html" class="product-img">
						<!--Image-->
						<img class="primary blur-up lazyload" data-src="assets/images/products/product-4.jpg" src="assets/images/products/product-4.jpg" alt="image" title="" width="800" height="960">
						<!--End image-->
						<!--Hover image-->
						<img class="hover blur-up lazyload" data-src="assets/images/products/product-4-1.jpg" src="assets/images/products/product-4-1.jpg" alt="image" title="" width="800" height="960">
						<!--End hover image-->
			...
			<div class="item">
				...
				<div class="product-image">
					...
					<a href="product-layout1.html" class="product-img">
						<!--Image-->
						<img class="primary blur-up lazyload" data-src="assets/images/products/product-5.jpg" src="assets/images/products/product-5.jpg" alt="image" title="" width="800" height="960">
						<!--End image-->
						<!--Hover image-->
						<img class="hover blur-up lazyload" data-src="assets/images/products/product-5-1.jpg" src="assets/images/products/product-5-1.jpg" alt="image" title="" width="800" height="960">
						<!--End hover image-->
					</a>
					<!--End Product Image-->

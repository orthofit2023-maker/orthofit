...
<table class="table table-striped" <?php echo ($_GET['dl']=="xls" ? 'border="1"' : '')?>>
  ...
  <tbody>
	<?php 
	$i=0; 
	$sql="SELECT o.orderid, date_format(o.orddate,'%d/%b/%y') as dt, o.orddate, o.ordtotal, o.ordcur, concat(c.username,' ',c.lastname) as user, concat(o.username,' ',o.lastname) as ouser, o.email FROM `ccd9orders` o join ccd9company c on c.email=o.email where o.status='0'  ";
	...
	$sql=$sql." group by o.orderid order by o.orderid desc";

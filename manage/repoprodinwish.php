...
if($_GET['dl']=="xls" && checkuseraccess(0,0,5)){
	...
	header("Content-disposition:attachment;filename=repoprodinwish.xls"); 
	header("Expires: 0");
...
?>
<div class="header">
	<h1 class="page-title">Products in Wishlist</h1>
	<ul class="breadcrumb">
	<li><a href="index.php">Home</a> </li>
	<li class="active">Products in Wishlist</li>
	</ul>
...
<div class="btn-toolbar list-toolbar">
	<form method="get" name="frm" action="repoprodinwish.php">
...
<table class="table table-striped" <?php echo ($_GET['dl']=="xls" ? 'border="1"' : '')?>>
  ...
  <tbody>
	<?php 
	$i=0; 
	$sql="SELECT count(*) as cnt, p.prodname, p.prodcode, p.produrl, c.prodid from ccd9wishlist c join ccd9products p on p.prodid=c.prodid where 1=1 ";

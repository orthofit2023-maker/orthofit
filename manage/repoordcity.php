...
if($_GET['dl']=="xls" && checkuseraccess(0,0,5)){
	...
	header("Content-disposition:attachment;filename=repoordcity.xls"); 
	header("Expires: 0");
...
?>
<div class="header">
	<h1 class="page-title">Sales by City</h1>
	<ul class="breadcrumb">
	<li><a href="index.php">Home</a> </li>
	<li class="active">Sales by City</li>
	</ul>
...
<div class="btn-toolbar list-toolbar">
	<form method="get" name="frm" action="repoordcity.php">
...
<table class="table table-striped" <?php echo ($_GET['dl']=="xls" ? 'border="1"' : '')?>>
  ...
  <tbody>
	<?php 
	$i=0; 
	$sql="SELECT sum(ordtotal) as cnt, countryname as country, city FROM `ccd9orders` o join ccd9country c on c.countryid=o.billing_country where o.status>0 ";
	...
	$sql=$sql." group by billing_city order by cnt desc";

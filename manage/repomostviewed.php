...
if($_GET['dl']=="xls" && checkuseraccess(0,0,5)){
	...
	header("Content-disposition:attachment;filename=repomostviewed.xls"); 
	header("Expires: 0");
...
?>
<div class="header">
	<h1 class="page-title">Most Viewed</h1>
	<ul class="breadcrumb">
...
<div class="btn-toolbar list-toolbar">
	<form method="get" name="frm" action="repomostviewed.php">
...
<table class="table table-striped" <?php echo ($_GET['dl']=="xls" ? 'border="1"' : '')?>>
  ...
  <tbody>
	<?php 
	$i=0; 
	$sql="SELECT count(*) as cnt, p.prodname, p.prodcode, p.produrl, c.prodid, p.prodprice, p.usdprice from ccd9prodviewed c left join ccd9products p on p.prodid=c.prodid where 1=1 ";

...
(function ($) {
	...
	function fit_swacthes() {
        var selector = '.swatches-fit li';
        $(selector).on('click', function () {
            $(selector).removeClass('active');
            $(this).addClass('active');
        });
	...
	/*-------------------------------
     35. Show new address for checkout
     ----------------------------------*/
    $('#btn-newaddress').on("click", function () {
        //$("#div-newaddress").toggleClass("d-none");
		$("#div-newaddress").removeClass("d-none");
	...
	$('.rdb-oldaddress').on("click", function () {
        //$("#div-newaddress").toggleClass("d-none");
		...
		$("#div-newaddress").addClass("d-none");
    });

	$('.rdb-newaddress').on("click", function () {
        //$("#div-newaddress").toggleClass("d-none");
		$("#billing_username").attr("required", false);
		$("#billing_lastname").attr("required", false);
		$("#billing_address").attr("required", false);
		$("#billing_city").attr("required", false);
		$("#billing_zipcode").attr("required", false);
		$("#billing_state").attr("required", false);
		$("#billing_country").attr("required", false);

		$("#div-newbilladdress").addClass("d-none");
    });

	 $('#btn-newbilladdress').on("click", function () {
        $("#div-newbilladdress").removeClass("d-none");
		$("#billing_username").attr("required", true);
		$("#billing_lastname").attr("required", true);
		$("#billing_address").attr("required", true);
		$("#billing_city").attr("required", true);
		$("#billing_zipcode").attr("required", true);
